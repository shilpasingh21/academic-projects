...
public class SparkLdaParameterEstimation {

	private static Logger logger = Logger.getLogger(SparkLdaParameterEstimation.class);
	...
	public static void main(String[] args) throws IOException {
		...
		logger.info("EM LDA PARAMETER ESTIMATION POC STARTED");
		...
		logger.info("EM LDA PARAMETER ESTIMATION POC COMPLETED");
